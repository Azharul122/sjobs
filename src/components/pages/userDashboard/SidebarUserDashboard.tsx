      ...
      >
        <div className="h-full flex flex-col">
            ...
            <div className="space-y-6">
              <div>
                <div className="space-y-1">
                  <NavItem href="/user/user-overview" icon={RiStackLine}>
                    Overview
                  </NavItem>
                  <NavItem href="/user/applied-jobs" icon={IoBriefcaseOutline}>
                    Applied Jobs
                  </NavItem>
                  <NavItem href="/user/user-message" icon={IoBriefcaseOutline}>
                    Message
                  </NavItem>
                </div>
              </div>
          ...
          <div className="px-4 py-4 border-t border-gray-200">
            <div className="space-y-1">
              <NavItem href="/user/user-reset-password" icon={Settings}>
                Settings
              </NavItem>
              <NavItem>
                <button
