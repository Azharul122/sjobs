    ...
    if (values) {
      try {
        ...
        if (response?.data) {
          ...
          if (formatedValuesLogin) {
            const response = await loginApi(formatedValuesLogin).unwrap();
            if (response?.data) {
              router.refresh();
              ...
              if (decodedToken?.role === "SUPER_ADMIN") {
                ...
                router.push("/auth/recruiter-profile");
  ...
  return (
    <div className="min-h-[calc(100vh-57px)] flex items-center justify-center">
      <div className="grid md:grid-cols-2 grid-cols-1 h-full w-full">
        ...
        <div className="bg-white md:min-h-screen xl:pl-24 pl-8 pr-4 flex justify-center flex-col py-10 md:py-0">
          <div className="max-w-[600px]">
            <Image alt="" src={authlogo} className=" sm:size-40 size-24" />
            <h3 className="text-[28px] font-bold font-montserrat leading-[1.1] md:leading-[1.55] text-[#0077B5] md:mt-10 mt-5 mb-4">
              Create Account
            </h3>
            <p className="text-[#6B6B6B] md:text-[20px] text-[16px] font-medium md:leading-[1.55] leading-[1.1]">
              ...
              and check your spam folder for an OTP.
            </p>
          </div>
        </div>

        {/* Right Column (Blue Background) */}
        <div className="bg-[#004D6E] flex items-center justify-center py-10 md:py-0">
          <div className="w-full max-w-[700px] md:pl-11 pl-5 pr-3">
            ...
            >
              ...
              <div className="text-center text-white my-2">or Sign up With</div>
              ...
              {/* Sign In Link */}
              <div className="text-center text-[#F5F5F5] text-[16px] font-normal mt-4">
